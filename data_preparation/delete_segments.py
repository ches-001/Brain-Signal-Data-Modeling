...
if __name__ == "__main__":
    ...
    eeg_dir = os.path.join(script_dir, "../data/samples/EEG")
    nirs_dir = os.path.join(script_dir, "../data/samples/NIRS")

    # CLI Parsed parameters
    parser = argparse.ArgumentParser(description=f"Segments Generator")
    parser.add_argument("--eeg_path", type=str, default=eeg_dir, metavar='', help='EEG data path')
    parser.add_argument("--nirs_path", type=str, default=nirs_dir, metavar='', help='NIRS data path')
    ...
    try:
        ...
        os.remove(os.path.join(eeg_dir, "../EEG.csv"))
    ...
    try:
        ...
        os.remove(os.path.join(nirs_dir, "../NIRS.csv"))
    except Exception as e:
        logging.error(e)